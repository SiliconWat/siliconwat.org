        ...
        <div class="sky">
            <div class="component-wrapper">
                ...
                <div class="background-grid">
                    ...
                    <div class="background two"><img class="" src="components/sw-main/background-2.svg" /></div>
                    <div class="background three"><img class="" src="components/sw-main/background-3.svg" /></div>
                    <div class="background four"><img class="" src="components/sw-main/background-4.svg" /></div>
                </div>
                ...
                <img class="svg-image" src="components/sw-main/crane.svg" />
